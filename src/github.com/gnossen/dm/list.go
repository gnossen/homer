...
func ListParser(args[] string) (int, error) {
    ...
    switch args[0] {
    case "active": return LIST_ACTIVE, nil
    case "inactive": return LIST_INACTIVE, nil
    case "class": return LIST_CLASS, nil
    case "all": return LIST_ALL, nil
    default:  return 0, errors.New(errStr)
    }
}
